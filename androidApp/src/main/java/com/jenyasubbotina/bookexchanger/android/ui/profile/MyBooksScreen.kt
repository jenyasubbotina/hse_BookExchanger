package com.jenyasubbotina.bookexchanger.android.ui.profile
...
private fun SubGenreDetailedContent(
    ...
    Column(
        ...
        Row(
            ...
            Text(
                text = "Мои книги".uppercase(),
                color = colorResource(R.color.white),
            )
        }

        LazyColumn(
            modifier = Modifier.background(colorResource(R.color.white)).padding(bottom = 45.dp),
        ) {
